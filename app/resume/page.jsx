...
const about = {
  title: "About Me",
  description: `I'm a D4 Computer Engineering student at IPB University with a strong interest in cybersecurity, cloud infrastructure, and DevOps engineering. My current focus is on building secure, scalable systems while learning how automation and cloud-native technologies can improve reliability and performance.`,

  info: [
    { fieldName: "Name", fieldValue: "Rajib Zidan" },
    { fieldName: "Phone", fieldValue: "(+62) 896-0318-2662" },
    {
      fieldName: "Current Education",
      fieldValue: "D4 Computer Engineering - IPB University",
    },
    {
      fieldName: "Specialization",
      fieldValue: "Cybersecurity, Cloud & DevOps",
    },
    {
      fieldName: "Email",
      fieldValue: "rajibzidan22@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const education = {
  ...
  description:
    "Formal academic background focusing on computer engineering and networking.",
...
const certifications = {
  ...
  description:
    "Industry-recognized certifications in networking, cloud, and cybersecurity.",
  ...
  items: [
    ...
    {
      institution: "Amazon Web Services (AWS)",
      degree: "AWS Cloud Academy Foundations",
      duration: "2025",
      logo: "/images/education/aws-new.png",
    },
    {
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="certifications" className="w-full">
              <Section
                ...
                desc={certifications.description}
              >
                      ...
                      <TooltipProvider delayDuration={100}>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <div className="w-full h-[140px] xl:h-[150px] bg-[#232329] rounded-xl flex justify-center items-center group hover:bg-[#2b2b32] transition-all duration-300 border border-transparent hover:border-accent/20 cursor-pointer">
                          ...
                          <TooltipContent className="bg-[#1c1c22] border border-accent/20 px-4 py-2 rounded-lg shadow-xl z-50">
                            <p className="capitalize text-sm font-medium text-white">
                              {skill.name}
                            </p>
                          </TooltipContent>
                        </Tooltip>
